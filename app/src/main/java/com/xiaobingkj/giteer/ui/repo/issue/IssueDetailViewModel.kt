...
class IssueDetailViewModel: BaseViewModel() {
    ...
    val issueEvent = MutableLiveData<List<IssueDetailBean>>()

    fun getIssueDetail(name: String, issue: String, page: Int, perpage: Int = 100) {
        requestNoCheck({
            HttpRequestCoroutine.getIssueDetail(name, issue, page)
        }, {
