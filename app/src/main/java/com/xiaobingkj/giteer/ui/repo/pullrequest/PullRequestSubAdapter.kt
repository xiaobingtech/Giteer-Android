...
class PullRequestSubAdapter(): BaseQuickAdapter<PullRequestBean, QuickViewHolder>() {
    override fun onBindViewHolder(holder: QuickViewHolder, position: Int, item: PullRequestBean?) {
    ...
    override fun onCreateViewHolder(
        ...
        return QuickViewHolder(R.layout.item_issue, parent)
    }
}