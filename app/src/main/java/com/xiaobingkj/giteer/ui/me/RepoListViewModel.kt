...
class RepoListViewModel: BaseViewModel() {
    ...
    fun getUserRepoList(name: String, page: Int, perpage: Int = 100) {
        requestNoCheck({
            HttpRequestCoroutine.getUserRepoList(name, page)
        }, {
    ...
    fun getMyRepoList(page: Int, perpage: Int = 100) {
        requestNoCheck({
            HttpRequestCoroutine.getMyRepoList(page)
        }, {
            repoEvent.postValue(it)
        }, {
            errorEvent.postValue(it)
