...
class EnterpriseAdapter(): BaseQuickAdapter<EnterpriseDTO, QuickViewHolder>() {
    override fun onBindViewHolder(holder: QuickViewHolder, position: Int, item: EnterpriseDTO?) {
