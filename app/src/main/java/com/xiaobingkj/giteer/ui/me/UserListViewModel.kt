...
class UserListViewModel: BaseViewModel() {
    ...
    fun getUserUserList(isFollower: Boolean, name: String, page: Int, perpage: Int = 100) {
        requestNoCheck({
            HttpRequestCoroutine.getUserUserList(isFollower, name, page)
        }, {
    ...
    fun getMyUserList(isFollower: Boolean, page: Int, perpage: Int = 100) {
        requestNoCheck({
            HttpRequestCoroutine.getMyUserList(isFollower, page)
        }, {
            userEvent.postValue(it)
        }, {
            errorEvent.postValue(it)
